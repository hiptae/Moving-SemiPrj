...
public class MsgService {
	...
	public boolean deleteReceivedMsg(Long msgno) {
		return msgMapper.deleteReceivedMsg(msgno) > 0;
	}
	public boolean deleteSendedsdMsg(Long msgno) {
		return msgMapper.deleteSendedMsg(msgno) > 0;
	}
}
